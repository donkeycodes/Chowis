                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                <table class="table v-middle">
                                    <thead>
                                        <tr class="bg-light">
                                            <th class="border-top-0">Treatment Duration</th>
                                            <th class="border-top-0 m-r-2"><span class="actionTitle"> Action </span></th>
                                        </tr>
                                    </thead>
                                    <tbody id="treatdurationtbl">
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="row justify-content-end">
                                    <div class="col-sm-3 col-md-3">
                                        ...
                                        <div class="col-sm-12 saveAction">
                                            ...
                                            <button class="btn btn-success" data-toggle="modal" data-target="#newfrequency">New Duration</button>
                                        </div>
                                        </div>
                                    </div>
                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label class="col-md-12">Duration</label>
                                                    <div class="col-md-12">
                                                        <input type="text" placeholder="More than 6 Months" class="form-control form-control-line" id="durationname">
                                                    </div>
                                                    
                                            </div>
                                        </div>

                                        <button type="button" class="btn btn-success float-right" data-dismiss="modal" id="saveduration">Save</button>
                                      </div>
                                    </div>
