                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                <table class="table v-middle">
                                    <thead>
                                        <tr class="bg-light">
                                            <th class="border-top-0">Frequencies</th>
                            ...
                            <div class="row justify-content-end">
                                    <div class="col-sm-3 col-md-3">
                                        ...
                                        <div class="col-sm-12 saveAction">
                                            ...
                                            <button class="btn btn-success" data-toggle="modal" data-target="#newfrequency">New Frequency</button>
                                        </div>
                                        </div>
                                    </div>
                            </div>
                                  ...
                                  <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        <h4 class="modal-title">New Frequency</h4>
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label class="col-md-12">Treatment Frequency</label>
                                                    <div class="col-md-12">
                                                        <input type="text" placeholder="Every Evening" class="form-control form-control-line" id="freqname">
                                                    </div>
                                                    
                                            </div>
                                        </div>

                                        <button type="button" class="btn btn-success float-right" data-dismiss="modal" id="savefreq">Save</button>
                                      </div>
                                    </div>
