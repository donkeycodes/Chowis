                            ...
                            <div class="row justify-content-end">
                                    <div class="col-sm-3 col-md-3">
                                        ...
                                        <div class="col-sm-12 saveAction">
                                            ...
                                            <button class="btn btn-success" data-toggle="modal" data-target="#newfrequency">New Brand</button>
                                        </div>
                                        </div>
                                    </div>
                            </div>
                                  ...
                                  <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label class="col-md-12">Brand</label>
                                                    <div class="col-md-12">
                                                        <input type="text" placeholder="Laneige" id="brandname" class="form-control form-control-line">
                                                    </div>                                                    
                                                    <div class="col-sm-12 saveAction">
                                                        <div class="checkform">
                                        ...
                                        <button type="button" class="btn btn-success float-right" data-dismiss="modal" id="savebrand">Save</button>
                                      </div>
                                    </div>
