                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <!-- <div class="treatmentmenu"> -->
                                        <div class="col-sm-8 offset-sm-2 treatmentmenu">
                                            <div class="col-lg-6  col-xlg-6  col-md-6 ">
                                             <!-- <button type="button" class="btn btn-lg btn-success btn-block btnMenu" onclick="/productlist">Moisture</button> -->
                                             <a href="TreatmentMoistureList" class="btn btn-lg btn-success btn-block btnMenu" role="button">Moisture</a>
                                            <!-- <button type="button" class="btn btn-lg btn-success btn-block btnMenu mt-1">Pores</button> -->
                                            <a href="TreatmentPores" class="btn btn-lg btn-success btn-block btnMenu" role="button">Pores</a>
                                            <!-- <button type="button" class="btn btn-lg btn-success btn-block btnMenu mt-1">Impurities</button> -->
                                            <a href="TreatmentImpurities" class="btn btn-lg btn-success btn-block btnMenu" role="button">Impurities</a>
                                        </div>
                                        <div class="col-lg-6 col-xlg-6 col-md-6">
                                            <!-- <button type="button" class="btn btn-lg btn-success btn-block">Spots</button> -->
                                            <a href="TreatmentSpots" class="btn btn-lg btn-success btn-block btnMenu" role="button">Spots</a>
                                            <!-- <button type="button" class="btn btn-lg btn-success btn-block mt-1">Wrinkles</button> -->
                                            <a href="TreatmentWrinkles" class="btn btn-lg btn-success btn-block btnMenu" role="button">Wrinkles</a>
                                            <!-- <button type="button" class="btn btn-lg btn-success btn-block mt-1">Keratin</button> -->
                                            <a href="TreatmentKeratin" class="btn btn-lg btn-success btn-block btnMenu" role="button">Keratin</a>
                                        </div>
                                        </div>
